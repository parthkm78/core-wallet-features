...
const getInfo = async (req, res) => {
  try {
    ...
    const validatorInfo = await stakeManagerContract.validators(valId.toString())
    
    res.status(HTTP_STATUS_CODE.OK)
      .json(successResponse(" Validator info fetched sucessfuly", { validatorInfo : validatorInfo}));
  }
  catch (err) {
